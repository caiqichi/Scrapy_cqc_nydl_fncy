from Scrapy_NYDL_FNCY_guangdong import upload_replace as ur
from Scrapy_NYDL_FNCY_guangdong.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_guangdong.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class GuangdongxhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%b9%e3%b6%ab%b7%e7%b5%e7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b9%e3%b6%ab%b7%e7%b5%e7&page={0}".format(num)
