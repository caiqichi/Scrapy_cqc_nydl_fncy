from Scrapy_NYDL_FNCY_jiling import upload_replace as ur
from Scrapy_NYDL_FNCY_jiling.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_jiling.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class JilingxhInfoSpider(scrapy.Spider):
    name = 'jilingxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u5409%u6797%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%bc%aa%c1%d6%b7%e7%b5%e7&page={0}".format(num)
