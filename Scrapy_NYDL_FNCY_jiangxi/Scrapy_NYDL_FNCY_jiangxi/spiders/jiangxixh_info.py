from Scrapy_NYDL_FNCY_jiangxi import upload_replace as ur
from Scrapy_NYDL_FNCY_jiangxi.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_jiangxi.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class JiangxixhInfoSpider(scrapy.Spider):
    name = 'jiangxixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u6C5F%u897F%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%bd%ad%ce%f7%b7%e7%b5%e7&page={0}".format(num)
