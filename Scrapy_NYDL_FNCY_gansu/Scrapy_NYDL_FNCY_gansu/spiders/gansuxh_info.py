from Scrapy_NYDL_FNCY_gansu import upload_replace as ur
from Scrapy_NYDL_FNCY_gansu.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_gansu.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class GansuxhInfoSpider(scrapy.Spider):
    name = 'gansuxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u7518%u8083%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b8%ca%cb%e0%b7%e7%b5%e7&page={0}".format(num)
