from Scrapy_NYDL_FNCY_fujian import upload_replace as ur
from Scrapy_NYDL_FNCY_fujian.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_fujian.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class FujianxhInfoSpider(scrapy.Spider):
    name = 'fujianxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u798F%u5EFA%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b8%a3%bd%a8%b7%e7%b5%e7&page={0}".format(num)
