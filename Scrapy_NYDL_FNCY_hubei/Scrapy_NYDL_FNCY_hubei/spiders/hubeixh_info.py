from Scrapy_NYDL_FNCY_hubei import upload_replace as ur
from Scrapy_NYDL_FNCY_hubei.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_hubei.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HubeixhInfoSpider(scrapy.Spider):
    name = 'hubeixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u6E56%u5317%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%ba%fe%b1%b1%b7%e7%b5%e7&page={0}".format(num)
