from Scrapy_NYDL_FNCY_shanghai import upload_replace as ur
from Scrapy_NYDL_FNCY_shanghai.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_shanghai.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ShanghaixhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%C9%CF%BA%A3%B7%E7%B5%E7']
