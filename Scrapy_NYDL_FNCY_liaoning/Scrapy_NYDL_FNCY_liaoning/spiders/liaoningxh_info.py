from Scrapy_NYDL_FNCY_liaoning import upload_replace as ur
from Scrapy_NYDL_FNCY_liaoning.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_liaoning.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class LiaoningxhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u8FBD%u5B81%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c1%c9%c4%fe%b7%e7%b5%e7&page={0}".format(num)
