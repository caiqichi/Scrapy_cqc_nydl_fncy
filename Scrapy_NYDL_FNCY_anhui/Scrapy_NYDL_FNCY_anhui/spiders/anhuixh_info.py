from Scrapy_NYDL_FNCY_anhui import upload_replace as ur
from Scrapy_NYDL_FNCY_anhui.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_anhui.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class AnhuixhInfoSpider(scrapy.Spider):
    name = 'anhuixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u5B89%u5FBD%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b0%b2%bb%d5%b7%e7%b5%e7&page={0}".format(num)
