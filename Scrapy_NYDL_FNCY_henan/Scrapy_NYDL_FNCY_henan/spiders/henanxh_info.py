from Scrapy_NYDL_FNCY_henan import upload_replace as ur
from Scrapy_NYDL_FNCY_henan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_henan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HenanxhInfoSpider(scrapy.Spider):
    name = 'henanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%BA%D3%C4%CF%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%ba%d3%c4%cf%b7%e7%b5%e7&page={0}".format(num)
