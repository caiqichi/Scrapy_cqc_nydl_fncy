from Scrapy_NYDL_FNCY_chongqing import upload_replace as ur
from Scrapy_NYDL_FNCY_chongqing.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_chongqing.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ChongqingxhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u91CD%u5E86%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%d6%d8%c7%ec%b7%e7%b5%e7&page={0}".format(num)
