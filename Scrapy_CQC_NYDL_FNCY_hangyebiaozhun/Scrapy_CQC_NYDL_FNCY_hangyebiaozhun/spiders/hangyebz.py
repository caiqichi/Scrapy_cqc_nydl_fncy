...
from Scrapy_CQC_NYDL_FNCY_hangyebiaozhun.items import InfoItem
from Scrapy_CQC_NYDL_FNCY_hangyebiaozhun.pipelines import MongoDBPipeline
from Scrapy_CQC_NYDL_FNCY_hangyebiaozhun import upload_replace as ur
...
class HangyebzSpider(scrapy.Spider):
    name = 'hangyebz'
    # allowed_domains = ['ww']
    # start_urls = ['http://ww/']
    web_name = '行业标准信息服务平台'
...
if __name__ == "__main__":
    os.system("scrapy crawl hangyebz")
