from Scrapy_NYDL_FNCY_hlj import upload_replace as ur
from Scrapy_NYDL_FNCY_hlj.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_hlj.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HljxhInfoSpider(scrapy.Spider):
    name = 'hljxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u9ED1%u9F99%u6C5F%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%ba%da%c1%fa%bd%ad%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl hljxh_info')  ##改下爬虫名
