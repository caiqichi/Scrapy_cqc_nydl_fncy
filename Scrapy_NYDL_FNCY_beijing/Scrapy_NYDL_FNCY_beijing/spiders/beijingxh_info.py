from Scrapy_NYDL_FNCY_beijing import upload_replace as ur
from Scrapy_NYDL_FNCY_beijing.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_beijing.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class BeijingxhInfoSpider(scrapy.Spider):
    name = 'beijingxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%B1%B1%BE%A9%B7%E7%B5%E7']
