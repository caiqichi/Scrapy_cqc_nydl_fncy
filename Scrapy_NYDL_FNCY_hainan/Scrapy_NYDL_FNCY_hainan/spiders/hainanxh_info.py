from Scrapy_NYDL_FNCY_hainan import upload_replace as ur
from Scrapy_NYDL_FNCY_hainan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_hainan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HainanxhInfoSpider(scrapy.Spider):
    name = 'hainanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u6D77%u5357%u98CE%u7535']
...
if __name__ == '__main__':
    os.system('scrapy crawl hainanxh_info')  ##改下爬虫名
