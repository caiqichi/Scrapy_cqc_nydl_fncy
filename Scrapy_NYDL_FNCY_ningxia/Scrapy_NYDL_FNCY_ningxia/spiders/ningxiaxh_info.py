from Scrapy_NYDL_FNCY_ningxia import upload_replace as ur
from Scrapy_NYDL_FNCY_ningxia.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_ningxia.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class NingxiaxhInfoSpider(scrapy.Spider):
    name = 'ningxiaxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%C4%FE%CF%C4%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c4%fe%cf%c4%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl ningxiaxh_info')  ##改下爬虫名
