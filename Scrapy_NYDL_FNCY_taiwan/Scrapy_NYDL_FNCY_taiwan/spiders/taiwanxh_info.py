from Scrapy_NYDL_FNCY_taiwan import upload_replace as ur
from Scrapy_NYDL_FNCY_taiwan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_taiwan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class TaiwanxhInfoSpider(scrapy.Spider):
    name = 'taiwanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u53F0%u6E7E%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%cc%a8%cd%e5%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl taiwanxh_info')  ##改下爬虫名
