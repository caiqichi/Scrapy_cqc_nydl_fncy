from Scrapy_NYDL_FNCY_shandong import upload_replace as ur
from Scrapy_NYDL_FNCY_shandong.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_shandong.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ShandongxhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%C9%BD%B6%AB%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c9%bd%b6%ab%b7%e7%b5%e7&page={0}".format(num)
