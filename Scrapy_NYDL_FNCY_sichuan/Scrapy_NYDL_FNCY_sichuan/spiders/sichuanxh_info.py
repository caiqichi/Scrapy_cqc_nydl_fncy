from Scrapy_NYDL_FNCY_sichuan import upload_replace as ur
from Scrapy_NYDL_FNCY_sichuan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_sichuan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class SichuanxhInfoSpider(scrapy.Spider):
    name = 'sichuanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%CB%C4%B4%A8%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%cb%c4%b4%a8%b7%e7%b5%e7&page={0}".format(num)
