from Scrapy_NYDL_FNCY_shanxi import upload_replace as ur
from Scrapy_NYDL_FNCY_shanxi.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_shanxi.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ShanxiixhInfoSpider(scrapy.Spider):
    name = 'shanxiixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%C9%BD%CE%F7%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c9%bd%ce%f7%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl shanxiixh_info')  ##改下爬虫名
