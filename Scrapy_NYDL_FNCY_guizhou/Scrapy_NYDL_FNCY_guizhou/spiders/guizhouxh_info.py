from Scrapy_NYDL_FNCY_guizhou import upload_replace as ur
from Scrapy_NYDL_FNCY_guizhou.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_guizhou.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class GuizhouxhInfoSpider(scrapy.Spider):
    name = 'guizhouxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u8D35%u5DDE%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b9%f3%d6%dd%b7%e7%b5%e7&page={0}".format(num)
