...
from Scrapy_CQC_NYDL_FNCY_difangbiaozhun.items import InfoItem
from Scrapy_CQC_NYDL_FNCY_difangbiaozhun.pipelines import MongoDBPipeline
from Scrapy_CQC_NYDL_FNCY_difangbiaozhun import upload_replace as ur
...
class Difangbiaozhun1Spider(scrapy.Spider):
    name = 'difangbiaozhun1'
    # allowed_domains = ['www']
    # start_urls = ['http://www/']
    web_name = '地方标准信息服务平台'
    category = '能源电力'
...
if __name__ == "__main__":
    os.system("scrapy crawl difangbiaozhun1")
