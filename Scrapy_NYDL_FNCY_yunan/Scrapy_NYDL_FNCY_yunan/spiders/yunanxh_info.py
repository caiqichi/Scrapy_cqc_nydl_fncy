from Scrapy_NYDL_FNCY_yunan import upload_replace as ur
from Scrapy_NYDL_FNCY_yunan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_yunan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class YunanxhInfoSpider(scrapy.Spider):
    name = 'yunanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%D4%C6%C4%CF%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%d4%c6%c4%cf%b7%e7%b5%e7&page={0}".format(num)
