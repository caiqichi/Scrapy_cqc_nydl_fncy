from Scrapy_NYDL_FNCY_qinghai import upload_replace as ur
from Scrapy_NYDL_FNCY_qinghai.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_qinghai.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class QinghaixhInfoSpider(scrapy.Spider):
    name = 'qinghaixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%C7%E0%BA%A3%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c7%e0%ba%a3%b7%e7%b5%e7&page={0}".format(num)
