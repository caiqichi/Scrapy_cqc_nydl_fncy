from Scrapy_NYDL_FNCY_zhejiang import upload_replace as ur
from Scrapy_NYDL_FNCY_zhejiang.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_zhejiang.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ZhejiangxhInfoSpider(scrapy.Spider):
    ...
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u6D59%u6C5F%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%d5%e3%bd%ad%b7%e7%b5%e7&page={0}".format(num)
