from Scrapy_NYDL_FNCY_guangxi import upload_replace as ur
from Scrapy_NYDL_FNCY_guangxi.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_guangxi.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class GuangxixhInfoSpider(scrapy.Spider):
    name = 'guangxixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u5E7F%u897F%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%b9%e3%ce%f7%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl guangxixh_info')  ##改下爬虫名
