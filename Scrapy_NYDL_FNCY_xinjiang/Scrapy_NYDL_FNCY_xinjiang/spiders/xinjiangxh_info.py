from Scrapy_NYDL_FNCY_xinjiang import upload_replace as ur
from Scrapy_NYDL_FNCY_xinjiang.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_xinjiang.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class XinjiangxhInfoSpider(scrapy.Spider):
    name = 'xinjiangxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%D0%C2%BD%AE%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%d0%c2%bd%ae%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl xinjiangxh_info')  ##改下爬虫名
