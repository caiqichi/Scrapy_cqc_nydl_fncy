from Scrapy_NYDL_FNCY_shanxii import upload_replace as ur
from Scrapy_NYDL_FNCY_shanxii.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_shanxii.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class ShanxixhInfoSpider(scrapy.Spider):
    name = 'shanxixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u9655%u897F%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%c9%c2%ce%f7%b7%e7%b5%e7&page={0}".format(num)
