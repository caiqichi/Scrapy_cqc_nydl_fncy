from Scrapy_NYDL_FNCY_xizang import upload_replace as ur
from Scrapy_NYDL_FNCY_xizang.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_xizang.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class XizangxhInfoSpider(scrapy.Spider):
    name = 'xizangxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%CE%F7%B2%D8%B7%E7%B5%E7']
...
if __name__ == '__main__':
    os.system('scrapy crawl xizangxh_info')  ##改下爬虫名
