from Scrapy_NYDL_FNCY_hebei import upload_replace as ur
from Scrapy_NYDL_FNCY_hebei.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_hebei.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HebeixhInfoSpider(scrapy.Spider):
    name = 'hebeixh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%BA%D3%B1%B1%B7%E7%B5%E7']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%ba%d3%b1%b1%b7%e7%b5%e7&page={0}".format(num)
...
if __name__ == '__main__':
    os.system('scrapy crawl hebeixh_info')  ##改下爬虫名
