from Scrapy_NYDL_FNCY_hunan import upload_replace as ur
from Scrapy_NYDL_FNCY_hunan.pipelines import MongoDBPipeline
from Scrapy_NYDL_FNCY_hunan.items import InfoItem  # 需要修改下爬虫项目名！！！
...
class HunanxhInfoSpider(scrapy.Spider):
    name = 'hunanxh_info'
    # allowed_domains = ['w']
    start_urls = ['https://news.bjx.com.cn/zt.asp?topic=%u6E56%u5357%u98CE%u7535']
    ...
    def parse(self, response):
        ...
        #     next_page = "https://news.bjx.com.cn/zt.asp?topic=%ba%fe%c4%cf%b7%e7%b5%e7&page={0}".format(num)
